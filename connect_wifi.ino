...
const char* password = "put here wifi password";
*/
      ...
      if (client.available()) {             // if there's bytes to read from the client,
        ...
        if (c == '\n') {                    // if the byte is a newline character
          ...
          if (currentLine.length() == 0) {
            ...
            // Web Page Heading
            client.println("<body><h1>Welcome to Web Server</h1>");
            
            // Display current state, and ON/OFF buttons for GPIO 26  
            client.println("<p>Room1-GPIO26 - State " + output26State + "</p>");
            ...
            client.println("<p>Room2 - GPIO27 - State " + output27State + "</p>");
